...
[![版本](https://img.shields.io/badge/version-0.4.5-blue.svg)](https://github.com/user/pi-switch/releases)
...
| 🌉 **模型名网关** | 无状态按 `profile/model` 路由、SSE 流式、User-Agent 伪装、请求体过滤、OpenAI ↔ Anthropic 转换、原生 OpenAI Responses 透传、故障转移、断路器 |
